...
if __name__ == '__main__':
    ...
    with open(f'training_results/training_cvae_mse_losses_{training_date}.txt', 'w') as f: 
        f.write(json.dumps(all_mse_losses, sort_keys=True, indent=2))

    with open(f'training_results/training_cvae_nmse_losses_{training_date}.txt', 'w') as f:
